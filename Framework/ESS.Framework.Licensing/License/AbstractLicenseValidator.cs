...
using ESS.Framework.Licensing.Discovery;

namespace ESS.Framework.Licensing.License
{
    /// <summary>
    ...
    public abstract class AbstractLicenseValidator
    {
        ...
        /// </summary>
        protected readonly ILogger Log = ObjectContainer.Resolve<ILoggerFactory>().Create(typeof(LicenseValidator));
